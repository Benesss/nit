...
# Interface that enclose a transformation function
# Concrete transform must implements the `apply` method.
#
...
interface Function[FROM, TO]
	...
	# Filter: produce an iterator which each elemnt is transformed.
	#
	...
	# eg. with the Iterator as receiver and the transform as argument.
	# (see `Iterator::select`)
